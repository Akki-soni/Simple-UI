...
<p align="center">
  A modern number application that provides even and odd numbers, built with HTML, CSS, and JavaScript.
</p>
...
- **JavaScript**:
  ...
  - If the number is even, it calculates and displays the next three even numbers.
